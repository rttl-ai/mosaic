...
def parse_args():
    ...
    train_args.add_argument("--wandb_project_name", type=str, help="WandB project name")
    train_args.add_argument("--wandb_entity", type=str, help="WandB entity (username or org)")
